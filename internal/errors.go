...
// this package uses code from https://github.com/MarioCarrion/todo-api-microservice-example/blob/main/internal/errors.go
// that code base was inspiration for the general structure of this api, and the implementation of wrapped errors
// and hand rolled error codes seemed to work really well for this use case
